...
public class MenuUtama extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jLabel2.setText("TOKO BAJU SAGALA ENDAH");

    jButton3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    jButton3.setText("MASTER DATA");
  ...
  private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
    new Transaksi_Dialog().setVisible(true);
  }//GEN-LAST:event_jButton4ActionPerformed

  private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
    try {
      JasperPrint jprint = JasperFillManager.fillReport(getClass().getResourceAsStream("/perbajuan/laporantransaksi.jasper"), null, koneksi.openconn());
