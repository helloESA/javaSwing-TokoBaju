 ...
 * @author WahyudinAK
 */
public class List_Barang extends javax.swing.JDialog {
  ...
  public List_Barang(Transaksi_Dialog aView) {
    initComponents();
    this.aView=aView;
  ...
  public void cariTabel(){
    ...
    try {
      ...
      ResultSet res = con.createStatement().executeQuery("SELECT * FROM barang WHERE merek_baju LIKE '%"+txtCari.getText()+"%'");
      while(res.next()){
        String[] dataTampil={
          res.getString(1),
          res.getString(2),
      ...
      .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(jPanel2Layout.createSequentialGroup()
            ...
            .addComponent(txtCari, javax.swing.GroupLayout.PREFERRED_SIZE, 767, javax.swing.GroupLayout.PREFERRED_SIZE)))
        .addContainerGap())
    );
  ...
  private void tableUserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableUserMouseClicked
    ...
    try {
      if(row != -1){
        ...
        aView.getTxtHarga().setText(tableUser.getValueAt(row, 6).toString());
        this.dispose();
      }
    } catch (Exception e) {
